package com.peninsula.frc2024.logging.shims;
 ...
 */
public class LoggedTimedRobot extends IterativeRobotBase {
   ...
   */
  protected LoggedTimedRobot(double period) {
    super(period);
    m_startTime = Timer.getFPGATimestamp();
    addPeriodic(this::loopWithLog, period);
    NotifierJNI.setNotifierName(m_notifier, "TimedRobot");

    HAL.report(tResourceType.kResourceType_Framework, tInstances.kFramework_Timed);
  }

  protected void loopWithLog() {
    loopFunc();
