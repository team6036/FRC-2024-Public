...
public class CleanSideCenterRush implements AutoBase {
  @Override
  public RoutineBase getRoutine() {
    ...
    try {
      p1 = PeninsulaTrajectory.of("trajectories/CleanSideCenterRush/Center5a/data.out");
      p2 = PeninsulaTrajectory.of("trajectories/CleanSideCenterRush/Center4a/data.out");
        ...
        new ParallelRaceRoutine(
            ...
            new SequentialRoutine(
                ...
                new DrivePathRoutine(
                    new WantedTrajectory(p1), 1.15, FieldState.PieceType.CENTERLINE, 5),
                // Shoot center 5
